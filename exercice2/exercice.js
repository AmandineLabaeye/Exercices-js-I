/**
 * Created by sstienface on 14/10/2018.
 */

/* Modifiez le code suivant pour changer le innerHTML de myDiv2 */
document.getElementById('myDiv2').innerHTML = "Bonjour je m'appelle Amandine";
...
document.getElementById('myDiv').innerHTML= "Comment ça va ?";
